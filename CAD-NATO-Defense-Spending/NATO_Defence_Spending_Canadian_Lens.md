...
### The Single Biggest Catalyst: The CPSP Decision

The CPSP submarine decision (expected late June/early July 2026) is the one near-term, binary, market-relevant event in the entire portfolio. It is a roughly C$60–120B lifecycle award that will go entirely to one of two camps. The two finalists have very different public-market profiles:

**If Hanwha Ocean wins** — the submarine builder is Hanwha Ocean (KRX: 042660), a separate listed entity from the better-known Hanwha Aerospace (KRX: 012450). A first-ever KSS-III export win would be a landmark validation of Korean naval export ambitions and would likely affect sentiment across the Korean defence complex. Note, however, that Hanwha Aerospace has already had an enormous run: shares climbed 193% in 2025 on top of 154% in 2024, reached an all-time high in March 2026, and the K9/Chunmoo European order book — not Canada — is the primary driver. A submarine win would be incremental to an already richly-valued name.

**If TKMS wins** — the relevant entity is ThyssenKrupp Marine Systems, which ThyssenKrupp has been separating from the parent group. The structure of TKMS's public availability (spin-off vs. retained stake) determines whether retail investors can get clean exposure; this is worth verifying directly as the situation has been evolving. A win would be a major validation of the Type 212CD's export trajectory alongside the Norway order.

The point: the CPSP decision is the rare procurement event with a clear, dated, binary outcome — exactly the kind of catalyst that markets react to. It is also already widely anticipated, so much of the expected value may be priced in for both names ahead of the announcement.

### Publicly-Traded Companies With Identified Exposure

| Company | Ticker | Programs | Exposure Type | Notes |
|---|---|---|---|---|
| **Hanwha Aerospace** | KRX: 012450 | CPSP (sister co.), IFM (K9), Project Arrow | Land systems, parent group | Already up ~190% in 2025; Canada incremental to European K9/Chunmoo book |
| **Hanwha Ocean** | KRX: 042660 | **CPSP (submarine builder)** | Direct — naval | The actual KSS-III builder; CPSP win = first export |
...
| **Babcock International** | LON: BAB | CPSP sustainment (if Hanwha) | Indirect — ISS partner | Exclusive Hanwha ISS partner; UK-listed |
...
| **Algoma Steel** | TSX/NASDAQ: ASTL | CPSP (if Hanwha — steel MOU) | Indirect — conditional | C$345M arrangement contingent on Hanwha win |
...
**The Korean complex has already re-rated dramatically.** Hanwha Aerospace's two-year run (154% in 2024, 193% in 2025) means the structural Korean-defence-export thesis is well known and substantially priced. A CPSP win would be incremental rather than thesis-defining for the parent. The cleaner CPSP exposure is Hanwha Ocean (the actual submarine builder), but it carries the same "already-discovered" caveat.
...
|---|---|---|
| **CPSP preferred bidder** | Late Jun / early Jul 2026 | Hanwha Ocean, TKMS/ThyssenKrupp, Babcock, Algoma Steel |
| **NATO Summit** | Jul 7, 2026 | Broad European/Korean defence complex |
...
**🇨🇦 Canada left Ankara with a full slate of deliverables.** The July 8 PMO release, "Prime Minister Carney secures new defence partnerships," bundles the week's outcomes: the Defence, Security and Resilience Bank; an agreement-in-principle with Telesat for the ESCP-P program to use Telesat Lightspeed for sovereign Arctic military satellite communications (a multi-billion-dollar investment); an approximately C$800 million Kongsberg contract for Joint Strike Missiles; a Light Utility Vehicle project of 1,600 to 2,100 vehicles; a decision to join the NATO Innovation Sub-Fund; and an extension of Operation REASSURANCE to 2031 with personnel rising to 2,600. Canada will host the NATO 2027 Industry Forum, and announced roughly C$925 million in fresh Ukraine support (C$475M ammunition, ~C$400M armoured vehicles and sourcing, C$50M IT and engineering).

**🇨🇦 The submarine decision became a formal three-nation partnership.** Carney, German Chancellor Friedrich Merz, and Norwegian Prime Minister Jonas Gahr Støre issued a joint statement on July 7 confirming Canada's entry into the German-Norwegian Type 212CD program via TKMS, a step that could put up to 24 identical submarines across the three navies (up to 12 for Canada). The statement frames it as a strategic, long-term partnership reaching into investment, energy, AI, space, and critical minerals.

**🇨🇦 NATO's AWACS replacement will fly on a Canadian airframe.** An eleven-nation consortium (Belgium, Canada, Denmark, Germany, Latvia, Lithuania, Luxembourg, Netherlands, Norway, Romania, Sweden) will jointly procure up to ten Saab GlobalEye aircraft to replace the E-3 Sentry fleet, announced at the July 7 Defence Industry Forum, with negotiations opening and no contract yet signed. The GlobalEye is built on Bombardier's Canadian-made Global 6500; Sweden's PM Kristersson said Canada is separately in talks for six of its own.

**🧭 The Ankara Summit Declaration.** All 32 leaders reaffirmed an "ironclad" commitment to Article 5, named Russia "the long-term threat to Euro-Atlantic security and stability," pledged "€70 billion in military equipment, assistance and training for Ukraine" in 2026 with "at least equivalent levels in 2027," and stated "Iran must never have a nuclear weapon." On spending it records that European Allies and Canada raised core defence investment by "more than $139 billion" in 2025 and announces "more than $50 billion in new procurements." The text does not restate the 5% figure or add an interim milestone; The Hague spending review remains set for 2029. Rutte confirmed the next summit will be in Albania.

**🧭 New NATO 2026 spending estimates (July 7).** Five members are already above the 3.5% core target: Lithuania 5.33% of GDP, Estonia 5.1%, Latvia 4.92%, Poland 4.68%, Greece 3.65%. The United States sits at 3.17%, Germany 2.69%, the United Kingdom 2.56%, France 2.22%. Total alliance defence spending is estimated above US$1.8 trillion for 2026. Rutte said Europe and Canada are "already measuring 4%" one year into the ten-year pledge, with "258 billion dollars in extra investment" across 2025 and 2026.

**🛠️ The July 7 Defence Industry Forum.** Alongside GlobalEye: Northrop Grumman Triton maritime-surveillance drones; the 10th A330 tanker to the multinational fleet; a seven-nation pooled A400M fleet (Belgium, Croatia, France, Poland, Spain, Türkiye, UK); a US$988 million Poland Patriot PAC-2 GEM-T order; a European PAC-3 maintenance centre (US, Poland, Germany, Netherlands, Sweden); a Diehl VULCANO guided-155mm contract; and a UK-led twelve-nation deep-precision-strike initiative worth more than US$50 billion over ten years.

**🇺🇸 Washington supplied the disruption.** Trump called Spain "a terrible partner" and "a wasted cause" and ordered trade cut off after Madrid again refused the 5% pledge (holding at ~2.1%); demanded Greenland from Denmark, drawing pushback from Denmark's Frederiksen and Iceland's Frostadóttir; said he was "very disappointed with NATO" over Iran and declared the US-Iran memorandum "over"; and told Zelensky the US would license Ukraine to build Patriot interceptors. Underneath sits Defense Secretary Hegseth's six-month US force-posture review (concluding around December 2026) over the roughly 80,000 US troops in Europe, framing the "NATO 3.0" burden-shift onto Europe and Canada.

**🏦 Two financing tracks, big powers absent from both.** Canada's Defence, Security and Resilience Bank launched July 7 with nine founders (Canada, Albania, Belgium, Greece, Latvia, Luxembourg, Romania, Türkiye, Ukraine), a Canadian headquarters, and a 2027 target. The UK leads a rival Multilateral Defence Mechanism with the Netherlands, Finland, and Poland. Neither the UK, Germany, nor France joined the Canadian bank as a founder, though the UK says it is also working with Canada and calls the two complementary.

**🇺🇦🇰🇷 Partners.** Ukraine's Zelensky secured the €70 billion pledge and "security contributor" status, signed drone-production deals with Estonia, the Netherlands, and Denmark, banked up to 32 Swedish Gripens, and won a Trump commitment to license domestic Patriot production. South Korea's President Lee Jae-myung, attending one day after Hanwha lost the Canadian submarine competition, pitched a "Korea-NATO Defense Industry Partnership 2.0" and opened NATO procurement-framework talks; Korea did not join Canada's defence bank.

> ### 🔑 Key Finding — Post-Summit
> Ankara converted Canada from a country that mostly receives alliance capability into one that also supplies it: it left as a NATO submarine-trilateral partner, the maker of the airframe under NATO's next AWACS, the lead of a new multilateral defence bank headquartered on its own soil, and the host of the 2027 industry forum. The summit's real fault lines ran elsewhere: Spain's refusal of the 5% pledge and Trump's retaliation, the Greenland friction with Denmark and Iceland, and the absence of the UK, Germany, and France from both new financing banks. The one Canadian file still open is the fighter review, and every summit data point landed on Saab's side of that ledger.

---

## ⚡ Latest Developments — June 26, 2026
...
| # | Program | Domain | Prime Vendor(s) | Capability: Supplements / Adds | **Potential Economic Impact (Jobs \| Value \| Canadian Regions)** | Est. Cost (CAD) | Key Milestones | **US-Derived Alternative (Status)** | **Country of Origin** | **Allied Operators / Other Purchasers** |
|---|---|---|---|---|---||---|---|---|---|---|
| 0 | Victoria-Class Modernization (VCM) | Maritime — Submarine (Bridge) | Babcock Canada (ISS) / Safran Trusted 4D (CA) / Multiple | Bridge program: extends operational life of 4 Victoria-class to mid-to-late 2030s. 12 upgrade projects: digital periscopes, flank-array sonar, habitability, acoustic quieting. Only 1 of 4 boats currently operational | ~300 skilled trades (Babcock Canada ISS, ongoing); Safran install ~50 technicians 2030–33 | C$1B bridge program | NS (Halifax/Dartmouth), BC (Esquimalt/Victoria) | ~C$1B (12 projects) | Periscope contract C$118M → Safran Feb 2026; install 2030–2033 | — (no documented US competitor for periscope upgrade) | 🇬🇧 UK (Victoria-class hull); 🇫🇷 France (Safran periscopes); 🇨🇦 Canada (Babcock ISS) | 🇬🇧 UK (original Upholder-class operator, retired 1994); VCM upgrades bespoke to Canada — no direct parallel fleet |
| 1 | Canadian Patrol Submarine Project (CPSP) | Maritime — Submarine | TKMS (DE) or Hanwha Ocean (KR) | Supplements 4 aging Victoria-class (**only 1 operable** as of Jun 2026). Adds: 12 under-ice AIP submarines (3× fleet); KSS-III export variant redesigned to ~2,800t for Canadian ports; first-ever sub-launched VLS strike (KSS-III option) | ⚠️Hanwha: 22,500 jobs/yr avg; ⚠️C$94.1B GDP (bidder-est.). ⚠️TKMS: 50,000/yr peak; ⚠️C$86B GDP (bidder-est.) | Certain regardless of outcome: NS + BC (sustainment hubs). Scenario-dependent: ON (Algoma Steel, APMA/K9 JV), QC (Marmen, CAE), MB (Port Churchill-TKMS), AB | ⚠️ C$60–120B lifecycle | **Decision: late Jun/early Jul 2026 (before NATO Summit Jul 7)**; Contract ~2028; First boat 2032–35; Full fleet ~2043 | — US does not build/export conventional submarines | 🇩🇪 Germany (TKMS, Kiel) OR 🇰🇷 South Korea (Hanwha Ocean, Geoje) — pending | TKMS Type 212 family: 🇩🇪 Germany (6), 🇮🇹 Italy (4), 🇵🇹 Portugal (2), 🇬🇷 Greece (4), 🇳🇴 Norway (4 × 212CD on order). Hanwha KSS-III: 🇰🇷 ROK Navy only — Canada would be first export customer |
| 2 | River-class Destroyers (CSC) | Maritime — Surface | Irving Shipbuilding / BAE Systems / Lockheed Martin Canada | Supplements 12 Halifax frigates (30+ yrs old, ~40% ready). Adds: 15 destroyers with Mk 41 VLS, ballistic missile defence, advanced sonar | 5,250 jobs/yr; C$719.3M GDP/yr (NSS modelling) | Primary: NS (Irving Shipbuilding, Halifax/Dartmouth). Also: QC (CAE Montréal simulation), BC (MDA Richmond sensors), NL (Score supply chain) | C$22.2B (first 3); ⚠️~C$80B+ lifecycle | Contract Mar 2025; First delivery **2032–33**; Final ~2050 | Alion Science / Lockheed Martin consortium ❌ (2019 CSC shortlist; BAE Type 26 won) | 🇬🇧 UK (BAE Systems Type 26 design, Glasgow / Filton); 🇨🇦 Canada (Irving, Halifax build) | 🇬🇧 UK (8 × Type 26 / City-class, HMS Glasgow lead); 🇦🇺 Australia (9 × Hunter-class). Canada's 15-ship order is the largest Type 26 fleet of the three nations |
| 3 | Joint Support Ships (JSS) | Maritime — Logistics | Seaspan Vancouver Shipyards | Supplements: MV Asterix (interim). Restores: Organic at-sea replenishment lost when HMCS Protecteur/Preserver decommissioned in 2014 | ~2,000 workers (peak build) | C$3.4B program | Primary: BC (Seaspan North Vancouver). National supply chain | ~C$3.4B | HMCS Protecteur 2027; HMCS Preserver 2027/28 | — (NSS domestic-build mandate; US shipbuilders ineligible) | 🇩🇪 Germany (Berlin-class design, TKMS); 🇨🇦 Canada (Seaspan, North Vancouver build) | 🇩🇪 Germany (Berlin class, 3 ships); 🇳🇱 Netherlands (HNLMS Karel Doorman — Berlin-class derivative) |
| 4 | Polar Icebreakers | Maritime / Arctic | Davie (QC); Seaspan (BC) | Supplements aging CCGS Louis S. St-Laurent. Adds: Year-round heavy polar Arctic access; dual-use military support | ~2,000–3,000 workers per yard (peak) | C$6.4B total | Primary: QC (Davie Lévis — C$3.25B), BC (Seaspan North Vancouver — C$3.15B). Subcontracts: QC (ALMACO outfitting) | ~C$6.4B (C$3.25B Davie + C$3.15B Seaspan) | Contracts Mar 2025; First delivery by 2030 | — (NSS domestic-build mandate; US shipbuilders ineligible) | 🇨🇦 Canada (Davie QC + Seaspan BC build); 🇫🇮 Finland (Wärtsilä propulsion / icebreaking tech) | 🇨🇦 Canada bespoke; 🇺🇸 USA and 🇫🇮 Finland (ICE Pact partners) building own heavy icebreakers independently. Closest analogues: Finnish Polaris-class, US WAGB-10 Polar Star |
| 5 | Fighter Aircraft — F-35A + Gripen E (FFCP) | Air — Fighter | Lockheed Martin (USA) + Saab (SE) / Bombardier (QC) | Supplements 77 CF-18 Hornets (~40% readiness). **Mixed fleet now emerging**: Option A: ~30 F-35A + ~60 Gripen E; Option B: ~72–88 F-35A + ~72 Gripen E (140 total). 16 F-35As firm; long-lead paid for 14 more | F-35 Canadian content: ~3,000 high-tech jobs (JSF workshare). ⚠️Gripen (if 72): ~9,000–12,600 jobs claimed by Saab | F-35: ON (JSF supply chain), QC (CAE simulation + Bombardier if Gripen assembly). Gripen: QC (Bombardier), ON. Basing: AB (4 Wing Cold Lake), QC (3 Wing Bagotville) | ⚠️ C$19B (F-35 original); Gripen adds TBD; Option B could reach C$30B+ total | Review underway, no deadline; First 16 F-35s at Luke AFB 2026–30; Gripen decision TBD | Boeing F/A-18 Super Hornet ❌ (not shortlisted 2023); F-35 order now under review with Gripen addition | 🇺🇸 USA (F-35A, Lockheed Martin Fort Worth) + 🇸🇪 Sweden (Gripen E, Saab Linköping) — mix under review | F-35A (17+ nations): 🇺🇸 🇬🇧 🇮🇹 🇳🇱 🇳🇴 🇩🇰 🇧🇪 🇵🇱 🇫🇮 🇦🇺 🇯🇵 🇰🇷 🇮🇱 🇸🇬 🇨🇭 🇦🇹 🇨🇿. Gripen E: 🇸🇪 Sweden, 🇧🇷 Brazil, 🇨🇿 Czech Rep., 🇭🇺 Hungary, 🇿🇦 South Africa, 🇹🇭 Thailand, 🇨🇴 Colombia |
| 6 | Airborne Early Warning & Control (GlobalEye) | Air — ISR | Saab (SE) / Bombardier (QC) / CAE (QC) | Adds: Canada's FIRST-EVER AEW&C capability (~6 aircraft, 650 km detection, multi-domain surveillance) | ⚠️~3,000 jobs (1/3 production committed to Canada) | >C$5B | Primary: QC (Bombardier Montréal — aircraft platform; CAE Montréal — training franchise). Also: ON (supply chain) | >C$5B | Preferred supplier May 2026; Negotiations ongoing; No contract signed | Boeing E-7 Wedgetail ❌; L3Harris Aeris X ❌ — both US, both lost to Saab GlobalEye | 🇸🇪 Sweden (Saab Erieye radar + mission system); 🇨🇦 Canada (Bombardier Global 6500 airframe, Montréal) | 🇦🇪 UAE (3 aircraft, first operator), 🇫🇷 France (4 aircraft, OASISS programme), 🇸🇪 Sweden (2 aircraft). Canada's 6 aircraft would be 4th customer |
| 7 | MQ-9B SkyGuardian (RPAS) | Air / Maritime ISR | General Atomics / MDA (BC) | Supplements aging CP-140 Aurora. Adds: Armed, long-endurance (40+ hr) maritime and Arctic UAV surveillance | ~200 jobs (MDA ground stations + CAF operations) | C$2.49B (mostly US-flow) | BC (MDA Richmond — C$74M GCS), NS (14 Wing Greenwood basing), BC (19 Wing Comox basing), ON (Ottawa remote ops hub) | C$2.49B | Contract Dec 2023; First delivery 2028; FOC 2033 | ✅ General Atomics (US) selected | 🇺🇸 USA (General Atomics, Poway CA); 🇨🇦 Canada (MDA ground stations, Richmond BC) | 🇺🇸 USA (extensive MQ-9A/B fleet), 🇬🇧 UK, 🇮🇹 Italy, 🇫🇷 France, 🇳🇱 Netherlands, 🇧🇪 Belgium, 🇩🇪 Germany, 🇦🇺 Australia, 🇯🇵 Japan, 🇹🇼 Taiwan, 🇮🇳 India |
| 8 | P-8A Poseidon (MPA) | Air / Maritime Patrol | Boeing | Replaces CP-140 Aurora (1980s). Adds: NATO-standard ASW and maritime patrol with modern sensors and sonobuoys | ~300–500 jobs (Canadian ITB + CAF basing) | C$5.9–7.7B (mostly US-flow) | Primary basing: NS (14 Wing Greenwood). QC (CAE Aurora sim). Limited manufacturing impact | ~C$5.9–7.7B | Aurora retirement ~2030s; acquisition timeline TBC | ✅ Boeing (US) selected | 🇺🇸 USA (Boeing, Renton WA / Seattle) | 🇺🇸 USA, 🇬🇧 UK, 🇮🇳 India, 🇦🇺 Australia, 🇳🇿 NZ, 🇳🇴 Norway, 🇩🇪 Germany, 🇫🇷 France, 🇰🇷 South Korea — de facto NATO/Five Eyes standard maritime patrol aircraft |
| 9 | Arctic Over-the-Horizon Radar (A-OTHR) | NORAD / Surveillance | BAE Systems Australia / DND | Replaces North Warning System (1986–92, obsolete ~2025). Adds: 3,000+ km OTH radar coverage against hypersonics and cruise missiles | ~500 jobs (construction phase, 3–5yr); ~200 permanent operations/maintenance | >C$6B | Primary: ON (main A-OTHR, Southern Ontario). NT or NU (polar radar sites). ON/QC (tech support firms) | >C$6B | Sites selected Jul 2025; A-OTHR operational 2029; Polar OTHR ~2032 | Raytheon / US OTHR vendors — no documented formal competitor; BAE Australia JORN tech won | 🇦🇺 Australia (BAE Systems Australia; JORN-derived OTH technology, Edinburgh SA) | 🇦🇺 Australia only (Jindalee OTH-B, operational since 1999); Canada is the first nation to license and apply the JORN technology outside Australia |
| 10 | CAF Cyber Command (CAFCYBERCOM) | Cyber / Digital | Government / CSE / Industry partners | Adds: Canada's first unified military cyber command integrating offensive/defensive operations and SIGINT into joint warfighting | ~2,000–3,000 military + civilian cyber positions (CAF + CSE + contractors) | C$10.9B (5yr digital envelope) | Primary: ON (Ottawa NCR — CAFCYBERCOM HQ, CFS Leitrim SIGINT). National distribution across CAF bases | C$10.9B (5yr digital envelope) | Established Sep 2024; Operational; Latvia deployment 2025 | — (domestic military programme; no US procurement equivalent) | 🇨🇦 Canada (domestic military command; no foreign platform) | No platform purchase — military command. Peer structures: 🇺🇸 US Cyber Command, 🇬🇧 UK National Cyber Force, 🇩🇪 CIR Kommando, 🇦🇺 Australian Cyber Security Centre |
| 11 | Enhanced Sat-Comms Polar (ESCP-P) | Space / SATCOM | Telesat (ON) / MDA Space (BC) | Adds: Canada's first sovereign Arctic military SATCOM — reduces total reliance on US satellite infrastructure for Arctic C2 | ~500 high-tech, high-wage space-sector jobs | >C$5B | Primary: ON (MDA Space Brampton — satellites; Telesat Ottawa — operations). Also: BC (MDA Richmond — engineering) | >C$5B | Partnership Dec 2025; Delivery target 2035 | ~ US WGS reliance (status quo dependence on US mil-sat) displaced by sovereign Canadian polar SATCOM | 🇨🇦 Canada (Telesat, Ottawa ON + MDA Space, Brampton ON) | Unique sovereign Canadian solution; no direct allied equivalent for polar LEO MILSATCOM. Conceptually parallels: 🇬🇧 Skynet, 🇫🇷 Syracuse, 🇺🇸 WGS (which Canada is moving away from) |
| 12 | Indirect Fires Modernization (IFM) | Land — Artillery | GDLS-Canada + KNDS (DE) / Hanwha (KR) / TBD | Replaces 33 towed M777 howitzers. Adds: 80–98 self-propelled 155mm howitzers; potential HIMARS rocket artillery (150–300 km range) | ~1,800 jobs (GDLS-Canada London, existing + new line) | C$3–6B program | Primary: ON (GDLS-Canada London). Possible additional if K9 selected: Korean build reduces Canadian manufacturing share | ⚠️ Est. C$3–6B | RFI 2025; Contract TBD; Delivery mid-2030s | BAE Systems M109A7 Paladin (US) — not formally offered; no US SP howitzer in competition | 🇩🇪 Germany / 🇨🇦 Canada (Grizzly LAV SPH, GDLS-Canada + KNDS) OR 🇰🇷 South Korea (K9) — TBD | K9 (if selected): 🇰🇷 ROK, 🇳🇴 Norway, 🇫🇮 Finland, 🇵🇱 Poland, 🇪🇪 Estonia, 🇮🇳 India, 🇦🇺 Australia, 🇪🇬 Egypt, 🇳🇴 Norway — NATO-wide adoption. Grizzly SPH: new platform (Canada would be launch customer) |
| 13 | Ground-Based Air Defence (GBAD) | Land — Air Defence | TBD (NASAMS or equivalent likely) | Supplements RBS70NG MANPADS. Adds: Medium-range surface-to-air missiles; counter-drone and cruise-missile intercept capability | ~200 Canadian content jobs (ITB obligations on TBD prime) | C$500M–C$1B | Limited specific regional manufacturing. Basing/operations: distributed nationally across CAF bases | C$500M–C$1B (Ph 2–3) | Ph 1 contract 2026; IOC Nov 2027 | Raytheon Patriot (US) ❌ not shortlisted; note: NASAMS (TBD selection) includes Raytheon AIM-120 missile content | 🇳🇴 Norway / 🇺🇸 USA (NASAMS: Kongsberg Kongsberg + Raytheon AIM-120) — if selected | NASAMS: 🇺🇸 USA, 🇳🇴 Norway, 🇳🇱 Netherlands, 🇫🇮 Finland, 🇪🇸 Spain, 🇭🇺 Hungary, 🇱🇹 Lithuania, 🇺🇦 Ukraine, 🇶🇦 Qatar, 🇦🇺 Australia — NATO's most widely deployed medium SHORAD |
| 14 | Canadian Modular Assault Rifle (CMAR) | Land — Individual Weapons | Colt Canada (ON) | Replaces C7 rifle and C8 carbine (40+ yrs). Adds: 65,402 modular rifles with suppressors, modern optics, ambidextrous controls; 80% Canadian content | ~150–200 manufacturing jobs (5yr build + sustainment) | C$10M/yr GDP; ~C$307M Ph 1 | Primary: ON (Colt Canada, Kitchener — 80% Canadian content mandate) | ~C$307M (Ph 1); ⚠️~C$273M reported total Ph 1 | Contract Mar 2026; Deliveries from 2027; Complete ~2031 | — (Colt Canada prime; platform is US M16/AR-15 lineage but manufactured in Canada) | 🇨🇦 Canada (Colt Canada, Kitchener ON; M16/AR-15 design lineage 🇺🇸 USA) | C7/C8 variants exported to 🇳🇱 Netherlands, 🇩🇰 Denmark, 🇳🇴 Norway; CMAR (C25/C26) is a new Canadian development — no other confirmed operators yet |
| 15 | Logistics Vehicle Modernization (LVM) | Land — Logistics | GDLS-Canada + Marshall Canada (NB) | Replaces aging LSVW/MLVW truck fleets. Adds: 1,500+ modern tactical trucks (Mercedes Zetros); enhanced payload, protection, communications | ~1,550 jobs/yr (GDLS-Canada + Marshall Canada + Manac trailers) | C$2.58B | ON (GDLS-Canada London — vehicle assembly), NB (Marshall Canada Moncton — mission modules, new 82,000 sq ft facility), QC + AB + BC (Manac trailer production) | C$2.58B | Contract May 2024; Deliveries 2026–28 | Oshkosh Defense (US) truck platform ❌ — Mercedes Zetros (Germany) selected as base vehicle | 🇩🇪 Germany (Mercedes-Benz Zetros base vehicle, Daimler) + 🇨🇦 Canada (GDLS-Canada assembly; Marshall NB modules) | Mercedes Zetros used by 🇩🇪 Germany (Bundeswehr), 🇧🇷 Brazil and commercial operators in 50+ countries as base commercial vehicle |
| 16 | Pistol Replacement — C22 / C24 | Land — Individual Weapons | SIG Sauer (US/DE) | Replaces ~11,000 Browning Hi-Power pistols (WWII-era, in service since 1940s). Adds: 16,500 C22 (general) + 3,200 C24 (military police) SIG Sauer P320s; NATO-standard 9mm | Negligible Canadian manufacturing (SIG Sauer manufactured in New Hampshire, USA) | C$19.4M (mostly US-flow) | National distribution only; no significant regional industrial impact | C$19.4M | Contract Oct 2022; Final P320 delivery Mar 2024; Hi-Powers destroyed end 2024 | ✅ SIG Sauer P320 (US-manufactured, Newington NH) selected | 🇺🇸 USA (SIG Sauer, Newington NH; Swiss-origin parent company) | 🇺🇸 USA (M17/M18 — largest single military handgun contract in US history), 🇩🇰 Denmark, 🇫🇷 France, 🇦🇺 Australia, 🇩🇪 Germany, 🇵🇱 Poland and many others. Among the world's most widely adopted service pistols |
| 17 | Canadian Ranger Rifle Stock Remediation (C19) | Land — Arctic / Ranger | Colt Canada (ON) / SAKO (FI) | Active remediation of 6,800 Colt Canada C19 bolt-action rifles (7.62×51mm NATO / Tikka T3 CTR-derived). Laminated stocks cracking in extreme Arctic cold (−51°C). Rangers' primary polar-bear self-defence and survival tool | ~50 manufacturing jobs (Colt Canada stock remediation) | C$10M program | ON (Colt Canada Kitchener — stock manufacture). Indirect benefit: Arctic communities NT, NU, YT (Canadian Rangers operational readiness) | ~C$10M | Failures reported May 2025; Contract expected 2026; 3-year stock replacement | — (no US alternative; SAKO Finland design, Colt Canada manufacture) | 🇨🇦 Canada (Colt Canada manufacture); 🇫🇮 Finland (SAKO Tikka T3 CTR design origin) | 🇨🇦 Canada (Canadian Rangers) only; the C19 is a bespoke Canadian military variant with no other military operators |
| 18 | Domestic Arctic Mobility Enhancement (DAME) | Land — Arctic Mobility | BAE Systems BvS10 / ST Kinetics Bronco / TBD | Replaces BV206 Bandvagn (1983; 47 of 78 remaining). Adds: 130–170 amphibious Arctic all-terrain vehicles in 4 variants (troop, command, cargo, ambulance); crew 2, 8+ soldiers, 300 km range, 72-hr autonomous, amphibious | ~200–400 jobs (assembly if Canadian content secured; TBD at RFP stage) | C$500M–C$1B | TBD — limited industrial unless domestic assembly confirmed. Operational communities: NT, NU, YT, northern QC + ON + MB | ⚠️ C$500M–C$1B (was C$100–249M; budget escalated) | RFP 2026; Contract 2027; First delivery 2029; FOC 2032 | — (no documented US ATAV competitor; BvS10 UK/Sweden vs Bronco Singapore) | 🇬🇧 UK / 🇸🇪 Sweden (BAE Systems Hägglunds BvS10, Örnsköldsvik SE) OR 🇸🇬 Singapore (ST Kinetics Bronco) — TBD | BvS10: 🇸🇪 Sweden, 🇬🇧 UK (Royal Marines), 🇳🇱 Netherlands, 🇦🇹 Austria, 🇫🇷 France (VLTP-NP). Bronco: 🇸🇬 Singapore, 🇬🇧 UK (ATTAC programme), 🇹🇭 Thailand |
| 19 | Long Range Precision Strike — Land (HIMARS) | Land — Rocket Artillery | Lockheed Martin (US) | Adds: 26 M142 HIMARS multiple-launch rocket systems. New capability — 70–300 km precision strike; Canada has never operated rocket artillery. FMS contract finalised Jan 2026; announced Jun 2, 2026. **Also designed to integrate future anti-ship missiles for Arctic coast defence** | ~C$390M Canadian ITB (~15% of C$2.6B); ~500–750 jobs | ~C$390M Canadian content | ON or QC (likely Canadian ITB prime). Basing: national | **C$2.6B total** (incl. project management, infrastructure, contingency) | FMS contract finalised **Jan 2026**; announced Jun 2, 2026; **Deliveries from 2029** | ✅ Lockheed Martin M142 HIMARS (US) selected | 🇺🇸 USA (Lockheed Martin, Camden AR) | 🇺🇸 USA, 🇷🇴 Romania, 🇵🇱 Poland, 🇱🇹 Lithuania, 🇪🇪 Estonia, 🇹🇼 Taiwan, 🇦🇺 Australia, 🇲🇦 Morocco, 🇺🇦 Ukraine (combat-proven 2022–present), 🇯🇴 Jordan, 🇶🇦 Qatar |
| 20 | Fixed Wing Search and Rescue (CC-295 Kingfisher) | Air — SAR | Airbus Defence and Space (ES) | Replaces CC-115 Buffalo and CC-130H Hercules (SAR roles). Adds: 16 modern turboprop SAR aircraft; Arctic and coastal coverage | ~300–500 jobs (CAE simulation + ITB content + basing) | C$1–2B program | QC (CAE Montréal — sim), BC (19 Wing Comox), ON (8 Wing Trenton), NL (9 Wing Gander), MB (17 Wing Winnipeg) | Not publicly disclosed (est. C$1–2B) | Program 2015–2030; Deliveries ongoing | — (no major US finalist; 2016 FWSAR competition: Airbus C295 won over Leonardo C-27J, Bombardier Q-400) | 🇪🇸 Spain (Airbus Defence and Space, Seville; assembled San Pablo plant) | 🇪🇸 Spain, 🇵🇹 Portugal, 🇵🇱 Poland, 🇲🇽 Mexico, 🇨🇱 Chile, 🇮🇩 Indonesia, 🇰🇷 South Korea, 🇫🇮 Finland, 🇨🇿 Czech Rep., 🇯🇴 Jordan and 15+ more — one of the world's most exported fixed-wing SAR/MPA |
| 21 | Air-to-Air Refuelling / Transport (CC-330 Husky / A330 MRTT) | Air — Tanker-Transport | Airbus Defence and Space (ES) | Replaces CC-150 Polaris tanker-transport. Adds: 9 Airbus A330 MRTT enabling long-range fighter and maritime patrol refuelling; increases effective range of all RCAF platforms | ~300–400 jobs (CAE simulation + basing + ITB) | C$1–2B program | Primary: ON (8 Wing Trenton — basing HQ; CAE adjacent). QC (CAE Montréal simulation). National distribution | Not publicly disclosed (est. C$1–2B) | Contract awarded 2022; Program 2018–2031 | Boeing KC-46 Pegasus ❌ — the natural US MRTT competitor; Airbus A330 MRTT selected | 🇫🇷 France / 🇩🇪 Germany / 🇪🇸 Spain (Airbus consortium; final assembly Toulouse FR + Hamburg DE) | 🇬🇧 UK (14 × Voyager), 🇫🇷 France (12), 🇦🇺 Australia (7 × KC-30A), 🇪🇸 Spain (3), 🇳🇱 Netherlands (2), 🇸🇦 Saudi Arabia (6), 🇸🇬 Singapore (6), 🇰🇷 South Korea (4), NATO MRTT Unit (8 pooled) |
| 22 | Future Fighter Lead-In Training — M-346 Master (FFLIT) | Air — Training | Leonardo SpA (IT) / CAE (QC) | Adds: Canada's first domestic advanced jet training since CT-155 Hawk retired Mar 2024. ~30 M-346 Block 20s to replace ZERO current domestic capability. Trains for both F-35 and Gripen. CAE likely simulation partner | ~500–1,000 jobs (CAE Montréal simulation + ITPS North Bay + CAF training pipeline) | ⚠️C$2–3B est. (incl. sims; negotiations just opened) | QC (CAE Montréal — simulation prime), ON (North Bay — ITPS Canada M-346 fleet), AB (4 Wing Cold Lake — FFLIT basing), SK (15 Wing Moose Jaw — pilot training hub) | ⚠️ Est. C$2–3B (incl. simulators; ~30 aircraft × US$20–40M) | Negotiations launched G7 Jun 16, 2026 (Carney–Meloni); Austria first Block 20 delivery 2028; RCAF early 2030s | Boeing/Saab T-7A Red Hawk ❌; KAI/Lockheed Martin T-50 ❌ — both evaluated; Leonardo M-346 selected | 🇮🇹 Italy (Leonardo SpA, Venegono Superiore VA; Honeywell F124 engines 🇺🇸 USA) | 🇮🇹 Italy (60+), 🇮🇱 Israel (30 × Lavi), 🇸🇬 Singapore (12), 🇵🇱 Poland (8), 🇦🇹 Austria (12 Block 20, delivery 2028), 🇶🇦 Qatar (12), 🇲🇦 Morocco, 🇦🇿 Azerbaijan; 160+ sold across 20+ nations |
...
|---|---|---|---|---|---|---|---|---|---|---|---|
| 1a | CPSP — TKMS scenario | ~90 | **50%** | — | — | **40%** (Germany) | **10%** (Norway) | — | — | — | Construction Kiel; sustainment Canada; Canadian industrial content via Marmen/Seaspan |
| 1b | CPSP — Hanwha scenario | ~90 | **48%** | — | **7%** | — | — | **43%** | — | 2% | Construction Geoje; Babcock Canada ISS (UK expertise); Canadian sustainment |
| 2 | River-class Destroyers | ~80 | **65%** | 12% | **18%** | 3% | 2% | — | — | — | Built in Halifax (Irving); BAE Systems design/systems; Rolls-Royce MT30 turbines; Lockheed Martin Canada CMS |
| 3 | Joint Support Ships | ~3.4 | **75%** | 5% | — | 15% | 5% | — | — | — | Built at Seaspan Vancouver; German-derived Berlin-class design; Finnish propulsion elements |
| 4 | Polar Icebreakers | ~6.4 | **70%** | 3% | 2% | 5% | **18%** | — | — | 2% | Davie (QC) + Seaspan (BC) build; Finnish Wärtsilä/Kongsberg propulsion and icebreaking systems |
| 5 | F-35A | ~19 | 20% | **72%** | 5% | 3% | — | — | — | — | Built Fort Worth; BAE Systems UK workshare (~15% of each aircraft); Canadian ITB obligations |
| 6 | GlobalEye AEW&C | ~5 | 35% | 5% | — | — | **50%** (Sweden) | — | — | 10% | Saab Erieye radar and mission systems; Bombardier Global 6500 airframe (Canada); CAE training (Canada) |
| 7 | MQ-9B SkyGuardian | ~2.5 | 10% | **87%** | — | — | 3% | — | — | — | General Atomics prime (USA); MDA ground control stations (Canada, C$74M) |
| 8 | P-8A Poseidon | ~7 | 15% | **80%** | 2% | 3% | — | — | — | — | Boeing prime; some CAE/Canadian ITB content; minor UK avionics |
| 9 | A-OTHR | ~6 | **55%** | 10% | — | — | — | — | **30%** | 5% | BAE Systems Australia JORN technology; Canadian construction and installation teams |
| 10 | CAFCYBERCOM | ~10.9 | **72%** | 20% | 3% | 3% | — | — | 2% | — | Primarily domestic personnel and contracts; US hardware/software; minor Five Eyes integration costs |
| 11 | ESCP-P | ~5 | **62%** | 25% | — | 8% | 5% | — | — | — | Telesat + MDA Space (Canada); US satellite components; European launch and minor Scandinavian elements |
| 12 | IFM Howitzers | ~4 | **48%** | 5% | — | **42%** (Germany) | 3% | — | — | 2% | Assumes Grizzly LAV SPH (GDLS-Canada + KNDS Deutschland); if K9 selected: Korea ~43%, Canada ~40%, Europe ~5% |
| 13 | GBAD | ~0.75 | 20% | 40% | — | 5% | **35%** (Norway) | — | — | — | Likely NASAMS: Kongsberg (Norway) + Raytheon (USA) co-production |
| 14 | CMAR (C25/C26) | ~0.5 | **80%** | 15% | — | 2% | — | — | — | 3% | Colt Canada prime; 80% domestic content requirement; minor US licensing/components |
| 15 | LVM | ~2.58 | **55%** | 5% | — | **38%** (Germany) | 2% | — | — | — | GDLS-Canada assembly (London, ON); Mercedes-Benz Zetros base vehicles (Daimler, Germany) |
| 16 | C22/C24 Pistols | ~0.02 | 10% | **88%** | — | 2% | — | — | — | — | SIG Sauer manufactured in New Hampshire, USA; minimal Canadian content |
| 17 | C19 Remediation | ~0.01 | **72%** | 5% | — | — | **23%** (Finland) | — | — | — | Colt Canada manufacture; SAKO (Finland) stock components |
| 18 | DAME | ~0.75 | 38% | 5% | **35%** | 5% | 12% | — | — | 5% | BAE Systems Hägglunds (UK-owned, Swedish-heritage design); Canadian assembly anticipated; if Bronco: Other rises ~35% (Singapore) |
| 19 | HIMARS | ~5 | 15% | **82%** | — | — | 3% | — | — | — | Lockheed Martin prime; Canadian ITB obligations; minor Scandinavian components |
| 20 | CC-295 Kingfisher | ~1.5 | 20% | 5% | — | **70%** (Spain) | — | — | — | 5% | Airbus Defence and Space prime (Spain); Canadian ITB content |
| 21 | CC-330 Husky | ~1.5 | 18% | 3% | 5% | **70%** (DE/FR/ES) | — | — | — | 4% | Airbus MRTT prime (Germany/France/Spain); minor UK content (engines); Canadian ITB content |
| 22 | M-346 FFLIT | ~2.5 | 30% | 5% | — | **55%** (Italy) | — | — | — | 10% | Leonardo SpA prime (Italy); CAE simulation (Canada); government-to-government structure |
...
> **⚖️ Contested Point: Washington vs. "Buy European".** The content rules above are now the subject of an open transatlantic dispute. In February 2026 the US Department of Defense filed comments in the European Commission's consultation on overhauling the 2009 EU Defence Procurement Directive, opposing any "European preference" clause and warning that Washington would review the "Buy American" waivers roughly 19 EU states hold under Reciprocal Defense Procurement Agreements ([POLITICO, Feb 19, 2026](https://www.politico.eu/article/washington-lobbies-eu-against-buy-european-push-for-weapons-donald-trump/)). US Ambassador to the EU Andrew Puzder called the plan "a serious mistake," and the [US Mission to the EU](https://useu.usmission.gov/why-us-eu-defense-industrial-cooperation-matters-more-than-ever/) published a post objecting specifically to the SAFE and EDIP eligibility criteria. The exact wording of the Pentagon submission rests on POLITICO's reporting, it sits in the EU consultation file rather than a US press release, but its substance is confirmed by the US Mission's own published position. Brussels has held firm: SAFE's 35% non-EU content cap and its design-authority clause remain in force ([Regulation (EU) 2025/1106](https://eur-lex.europa.eu/eli/reg/2025/1106/oj/eng)), and the EU has widened access to trusted partners through Security and Defence Partnerships instead of loosening the rules. For the Canadian reader the asymmetry is the point: Canada is the first non-European country admitted to SAFE (partnership June 2025, participation agreement February 2026, Council adoption June 2026), placing it inside the "Buy European" architecture Washington is lobbying to loosen, while the United States, which holds no such partnership, remains outside it.
...
| Date | Milestone | Program(s) |
|---|---|---|
| 2021 | CPSP established by DND | CPSP |
| Oct 2022 | Pistol replacement contract (C22/C24 P320) + CC-330 Husky (A330 MRTT) contract awarded | C22/C24; CC-330 |
| Jan 2023 | F-35A contract signed (88 aircraft, ~C$19B) | FFCP / F-35 |
| Dec 2023 | MQ-9B SkyGuardian contract signed (C$2.49B, 11 aircraft) | MQ-9B |
| Mar 6, 2024 | Final C22/C24 P320 pistol deliveries complete; Browning Hi-Powers begin destruction | C22/C24 |
| May 2024 | LVM contract awarded — GDLS-Canada + Marshall Canada (C$2.58B) | LVM |
| Jul 2024 | Canada formally commits to up to 12 submarines at NATO Washington Summit | CPSP |
| Sep 26, 2024 | CAFCYBERCOM established (Maj-Gen Dave Yarker, inaugural commander) | CAFCYBERCOM |
| Jan 2025 | F-35 review ordered by Carney government | FFCP / F-35 |
| Mar 2025 | A-OTHR announced; River-class and polar icebreaker contracts awarded | A-OTHR; RCD; Icebreakers |
| May 2025 | C19 Ranger Rifle stocks reported cracking at −51°C in High Arctic | C19 Remediation |
| **Jun 9, 2025** | **C$9.3B defence surge announced; Canadian Coast Guard transferred to DND portfolio** (counted toward NATO spending) | 2% / CCG |
| Jun 2025 | NATO 5% GDP pledge at Hague Summit; A-OTHR Australia partnership; EU defence partnership signed | All programs |
| Aug 2025 | CPSP shortlisted to TKMS (Type 212CD) and Hanwha Ocean (KSS-III Batch-II) | CPSP |
| **Aug 8, 2025** | **CAF pay raise announced** — largest in a generation; retroactive to Apr 1, 2025: Pte +20%, Lt-Col and below +13%, Col and above +8%. New Military Service Pay lump-sum | CAF Personnel |
| Oct 2, 2025 | Defence Investment Agency (DIA) launched; CEO Doug Guzman | All DIA programs |
| Nov 2025 | CAF pay and retroactive lump sum hits mid-November payslips; CAE–Saab GlobalEye training cooperation agreement | CAF Personnel; GlobalEye |
| Nov 4, 2025 | Budget 2025: C$81.8B defence commitment over five years | All programs |
| Dec 9, 2025 | ESCP-P polar MILSATCOM partnership (Telesat + MDA Space) announced | ESCP-P |
| **Jan 2026** | **HIMARS FMS contract finalised with US (C$2.6B total; 26 launchers; announced Jun 2, 2026)** | HIMARS |
| Jan 30, 2026 | Norway signs K239 Chunmoo contract ($2B, 16 launchers) — choosing Chunmoo over HIMARS | Context |
| Feb 2026 | VCM periscope contract: C$118M to Safran Trusted 4D Canada Inc.; install 2030–33 | VCM |
| Feb 17, 2026 | Defence Industrial Strategy launched (C$6.6B, 70% domestic target, 125,000 jobs) | All programs |
| Mar 2, 2026 | CPSP final bids due from TKMS and Hanwha Ocean | CPSP |
| Mar 2026 | CMAR contract awarded to Colt Canada (~C$307M Phase 1; C25 GS + C26 FS variants) | CMAR |
| **Mar 26, 2026** | **Canada officially reaches NATO 2% GDP target (FY2025–26)** — first time since late 1980s. Achieved via C$9.3B surge + CCG portfolio transfer + CAF pay raise | 2% milestone |
| May 2026 | ITPS Canada (North Bay ON) orders 6 × M-346T Block 20 privately | M-346 / FFLIT |
| May 1, 2026 | HIMARS: Lockheed Martin production contract awarded on US side | HIMARS |
| May 27, 2026 | Saab GlobalEye named preferred AEW&C supplier (CANSEC); no contract yet | GlobalEye AEW&C |
| May 30, 2026 | La Presse reports working option of ~30 F-35A + ~60 Gripen E | FFCP / Fighter |
| **Jun 2, 2026** | **HIMARS publicly announced: C$2.6B total, 26 launchers, deliveries from 2029** | HIMARS |
| Jun 6, 2026 | CBC News: larger option of 72–88 F-35A + 72 Gripen E (~140 aircraft) also under evaluation | FFCP / Fighter |
| Jun 16, 2026 | Carney–Meloni G7 meeting (Évian): negotiations launched for Leonardo M-346 FFLIT (~30 aircraft) | M-346 / FFLIT |
| Jun 20, 2026 | Parliament enters summer recess; CPSP decision becomes administrative cabinet call | CPSP |
| **Late Jun / Early Jul 2026** | **⚡ CPSP preferred bidder expected before NATO Summit (Jul 7, 2026)** | **CPSP** |
| 2026 | First F-35As received at Luke AFB, Arizona; C19 stock contract expected; DAME RFP issued | F-35; C19; DAME |
| 2027 | HMCS Protecteur (JSS) delivery; CMAR Phase 1 deliveries begin; DAME contract awarded | JSS; CMAR; DAME |
| 2028 | First F-35A arrives in Canada; First MQ-9B delivery; CPSP binding contract expected | F-35; MQ-9B; CPSP |
| **2029** | Arctic A-OTHR operational; DAME first deliveries; **HIMARS deliveries begin** (26 launchers, C$2.6B) | A-OTHR; DAME; HIMARS |
| 2030 | VCM digital periscope installation begins on Victoria class | VCM |
| **2032–33** | **First River-class destroyer (HMCS Fraser) commissioned**; polar icebreakers delivered; CC-295 Kingfisher complete; M-346 RCAF service entry | RCD; Icebreakers; CC-295; M-346 |
| ~2031 | CMAR Phase 2 complete (~65,000 rifles); CC-330 Husky program complete | CMAR; CC-330 |
| ~2032 | Polar OTHR operational | P-OTHR |
| 2033 | MQ-9B full operational capability | MQ-9B |
| 2035 | First CPSP submarine required; ESCP-P target; NATO 5% GDP target | CPSP; ESCP-P |
| 2033 | VCM periscope installation complete across Victoria fleet | VCM |
| ~2043 | Full CPSP submarine fleet (Hanwha schedule) | CPSP |
| ~2050 | Final River-class destroyer commissioned | RCD |
...
Many headline figures — 5% of GDP equalling C$150 billion per year, submarine lifecycle at C$60-120 billion, and bidder job projections — are estimates, bidder-commissioned, or not independently verified. Budget 2025 provided lump-sum five-year totals without year-by-year breakdowns, and no explicit submarine funding line appeared in the budget. The F-35 and CPSP decisions remain unresolved as of mid-2026; their outcomes could materially shift regional and integration impacts. Several "preferred supplier" announcements — GlobalEye, CPSP — are not yet binding contracts. European-language source translations in this report are the author's own. TKMS's delivery-slot transfer offer from Germany and Norway is a political commitment, not yet a contractual one.

---

## 📊 NATO Defence Spending by Country (% of GDP, 2020–2026)

*Canada is highlighted in the HTML chart (red bars) and bolded below. The interactive version supports per-year toggling across all seven years with threshold lines at 2% and 3.5%.*

This is the essential context for this entire report: Canada not only reached the 2% floor late (fiscal 2025–26) but actually *declined* from 2020 to 2022 before reversing course — while eastern-flank allies climbed toward 4–5%.
...
**Sources:** NATO Defence Expenditure of NATO Countries (2014–2025); SIPRI Military Expenditure Database (Apr 2026); European Parliament EU Member States' Defence Budgets (Mar 2026); UK Government International Defence Statistics Bulletin 2025; national budget documents. 2020–2023 are NATO published figures; 2024–2025 are NATO estimates; 2026 figures are budgeted or projected and subject to revision. Country set is representative, not exhaustive (Iceland excluded — no armed forces).

**What the data shows.** Canada sits at the bottom of this representative set in 2026, tied with Spain and just above Italy — the three large NATO economies that reached 2% latest. The seven-year view exposes something the single-year snapshot hides: Canada's defence burden *fell* from 1.42% (2020) to 1.27% (2022) — the post-pandemic low — before the Russia-Ukraine war and US pressure forced a reversal. The jump from 1.45% (2024) to 2.00% (2025) is the steepest single-year move in the set proportionally, reflecting the C$9.3B surge, the CCG portfolio transfer, and the CAF pay raise. The eastern-flank states (Estonia, Lithuania, Poland, Latvia) occupy a different tier entirely, with Estonia and Lithuania budgeting toward 5%+ for 2026 in direct response to the Russian threat on their borders. The structural takeaway: even at 2%, Canada remains a NATO laggard, and the 5%-by-2035 Hague pledge implies more than tripling the 2022 baseline.

---

## 🔗 Live Source Tracker

*This is a living document. The links below are live searches and source homepages, not static citations — click any to pull the latest information on each open thread. Last curated June 26, 2026.*

### 🎯 Active Watch Threads

**🔴 CPSP Submarine Decision** — Expected late Jun / early Jul 2026, before NATO Summit Jul 7. Watch for preferred bidder (TKMS vs Hanwha), contract value, fleet split.
- [Google News — CPSP preferred bidder](https://news.google.com/search?q=Canada%20submarine%20CPSP%20TKMS%20Hanwha%20preferred%20bidder)
- [Google News — Canada submarine decision 2026](https://news.google.com/search?q=Canada%20patrol%20submarine%20project%20decision%202026)
- [DND Newsroom](https://www.canada.ca/en/department-national-defence/news.html) · [CBC Politics](https://www.cbc.ca/news/politics)

**🟠 Fighter Review (F-35 / Gripen)** — No deadline. Watch for fleet size/composition, Gripen quantity, Saab Canadian assembly, data sovereignty.
- [Google News — Canada F-35 Gripen mixed fleet](https://news.google.com/search?q=Canada%20F-35%20Gripen%20mixed%20fleet%20decision)
- [Saab newsroom](https://www.saab.com/newsroom)

**🟡 M-346 / FFLIT Trainer** — Negotiations launched Jun 16, 2026. Watch for signed contract, quantity, CAE role, delivery schedule.
- [Google News — Canada M-346 Leonardo trainer](https://news.google.com/search?q=Canada%20M-346%20Leonardo%20advanced%20jet%20trainer%20FFLIT)
- [Leonardo press releases](https://www.leonardo.com/en/press-release-list)

**🔵 NATO Summit (Jul 7, 2026)** — Watch for new capability pledges, 5% pathway plans, Canadian announcements.
- [Google News — NATO Summit 2026 Canada](https://news.google.com/search?q=NATO%20summit%202026%20Canada%20defence%20spending)
- [NATO official news](https://www.nato.int/cps/en/natohq/news.htm)

**🟢 HIMARS / Long-Range Fires** — Contract finalised Jan 2026; deliveries from 2029. Watch for anti-ship integration, domestic munition production.
- [Google News — Canada HIMARS](https://news.google.com/search?q=Canada%20HIMARS%20long%20range%20precision%20strike)
- [True North Strategic Review](https://www.truenorthstrategicreview.ca/)

### 🇨🇦 Primary Canadian Sources
[DND Newsroom](https://www.canada.ca/en/department-national-defence/news.html) · [CBC Politics](https://www.cbc.ca/news/politics) · [Ottawa Citizen Defence Watch](https://ottawacitizen.com/category/news/national/defence-watch) · [True North Strategic Review](https://www.truenorthstrategicreview.ca/) · [Esprit de Corps](https://www.espritdecorps.ca/) · [Canadian Defence Review](https://canadiandefencereview.com/) · [Parliamentary Budget Officer](https://www.pbo-dpb.ca/en/publications) · [PM of Canada](https://www.pm.gc.ca/en/news) · [Wikipedia — Planned Canadian Forces Projects](https://en.wikipedia.org/wiki/Planned_Canadian_Forces_projects)

### 🌐 International & Allied Defence Press
[Breaking Defense](https://breakingdefense.com/) · [Defense News Global](https://www.defensenews.com/global/) · [Naval News](https://www.navalnews.com/) · [The Defense Post](https://thedefensepost.com/) · [Janes](https://www.janes.com/) · [Reuters Aerospace & Defense](https://www.reuters.com/business/aerospace-defense/)

### 🇪🇺 European & Allied-Language Sources
🇩🇪 [Hartpunkt](https://www.hartpunkt.de/) · 🇩🇪 [Produktion.de](https://www.produktion.de/ruestung-aerospace/) · 🇫🇷 [OPEX360](https://www.opex360.com/) · 🇫🇷 [Radio-Canada](https://ici.radio-canada.ca/) · 🇳🇴 [Teknisk Ukeblad](https://www.tu.no/) · 🇸🇪 [Saab](https://www.saab.com/newsroom) · 🇮🇹 [Analisi Difesa](https://www.analisidifesa.it/)

---

## 📚 Further Reading (APA 7th Edition)

**NATO defence spending data (for the spending chart):**

North Atlantic Treaty Organization. (2025, August). *Defence expenditure of NATO countries (2014–2025)*. NATO. https://www.nato.int/cps/en/natohq/news_237279.htm

Stockholm International Peace Research Institute. (2026). *SIPRI military expenditure database*. SIPRI. https://www.sipri.org/databases/milex

UK Ministry of Defence. (2025, December 4). *Finance and economics annual statistical bulletin: International defence 2025*. GOV.UK. https://www.gov.uk/government/publications/international-defence-expenditure-2025/finance-and-economics-annual-statistical-bulletin-international-defence-2025

European Parliamentary Research Service. (2026, March 9). *EU Member States' defence budgets*. European Parliament. https://epthinktank.eu/2026/03/09/eu-member-states-defence-budgets-2/


**EU defence spending and procurement (for the EU Spend Overview):**

European Commission. (2025, March 19). *Joint white paper for European defence readiness 2030*. European Commission. https://defence-industry-space.ec.europa.eu/eu-defence-industry/safe-security-action-europe_en

Council of the European Union. (2026). *What is Security Action for Europe (SAFE)?* Consilium. https://www.consilium.europa.eu/en/policies/safe/

White & Case LLP. (2025, March). *The big bang? European Commission unveils proposals to support surge in defence spending, reduce reliance on third countries*. https://www.whitecase.com/insight-alert/big-bang-european-commission-unveils-proposals-support-surge-defence-spending-reduce

Breaking Defense. (2026, May 8). *Poland becomes first nation to sign EU SAFE loans, expects billions for defense*. https://breakingdefense.com/2026/05/poland-becomes-first-nation-to-sign-eu-safe-loans-expects-billions-for-defense/

Center for European Policy Analysis. (2026, May 21). *A defense production plan for Europe*. CEPA. https://cepa.org/article/a-defense-production-plan-for-europe/

European Parliamentary Research Service. (2026, March 13). *EU joint defence procurement*. European Parliament. https://epthinktank.eu/2026/03/13/eu-joint-defence-procurement/


*Methodology note on the spending figures:* The 2020–2023 values are NATO's published actuals (which NATO periodically restates against revised GDP data, so minor variation between vintages is expected). The 2024 and 2025 values are NATO estimates as published in the 2014–2025 series. The 2026 values are not yet actuals — they blend confirmed national budget allocations (e.g., Germany, France) with stated government targets that remain subject to legislative approval and revision (e.g., the Baltic states' moves toward 5%). All 2026 figures should be read as projections, not settled outcomes.
